...
class bounciBall:
    def __init__(self):
        ...
        self.color = "purple"
        self.dx = random.randint(50,100)/25 # Random velocity on x-Achsis
        self.dy = random.randint(-100,-50)/25 # Rnadom velocitiy on y-Achsis in positiv Direction towards the grid
